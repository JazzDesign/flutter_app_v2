      ...
      home: Scaffold(
        body: Stack(
          children: <Widget>[
            ListView(
              children: <Widget>[
                DescriptionPlace("Antigua Guatemala", 4, dummyDescription),
                ReviewList()
              ],
            ),
            GradientBack()
